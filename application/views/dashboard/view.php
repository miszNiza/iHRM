...
<div id="rightSide">
        ...
        <div class="wrapper">
            ...
            <div class="userNav">
                <ul>
                    ...
                    <li class="dd"><a title=""><img src="images/icons/topnav/messages.png" alt="" /><span>Notifications</span><span class="numberTop">25</span></a>
    ...
    <div class="resp">
        <div class="respHead">
            <a href="index.html" title=""><img src="images/uda_logo.png" alt="" /></a>
        </div>
        ...
        <div class="smalldd">
            ...
            <ul class="smallDropdown">
                ...
                <li><a href="charts.html" title=""><img src="images/icons/light/stats.png" alt="" />Reports</a></li>
            </ul>
        </div>
        <div class="cLine"></div>
    </div>
    ...
    <div class="statsRow">
        <div class="wrapper">
        	<div class="controlB">
            	<ul>
                	<li><a href="#" title=""><img src="images/icons/control/32/plus.png" alt="" /><span>Add new record</span></a></li>
                    <li><a href="#" title=""><img src="images/icons/control/32/database.png" alt="" /><span>New manual entry</span></a></li>
                    ...
                    <li><a href="#" title=""><img src="images/icons/control/32/comment.png" alt="" /><span>Alerts</span></a></li>
                    <li><a href="#" title=""><img src="images/icons/control/32/order-149.png" alt="" /><span>Applications</span></a></li>
                </ul>
                <div class="clear"></div>
            </div>
        </div>
    ...
    <div class="wrapper">
        ...
        <div class="widget chartWrapper">
            <div class="title"><img src="images/icons/dark/stats.png" alt="" class="titleIcon" /><h6>Staff Movement</h6></div>
        ...
        <div class="widgets">
            <div class="oneTwo">
                ...
                <div class="widget">
                    <div class="title"><img src="images/icons/dark/users.png" alt="" class="titleIcon" /><h6>Latest Activity</h6></div>
                    <ul class="partners">
                        <li>
                ...
                <div class="widget">
                    <div class="title"><img src="images/icons/dark/stats.png" alt="" class="titleIcon" /><h6>Leave Ratio</h6></div>
            ...
            <div class="oneTwo">
                ...
                <!-- New users widget -->
                <div class="widget">
                    <div class="title"><img src="images/icons/dark/add.png" alt="" class="titleIcon" /><h6>Highest paid</h6></div>
                    <div class="wUserInfo">
