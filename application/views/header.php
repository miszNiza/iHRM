...
<script type="text/javascript" src="<?php echo site_url('assets/js'); ?>/plugins/charts/jquery.flot.pie.js"></script>
<script type="text/javascript" src="<?php echo site_url('assets/js'); ?>/plugins/charts/jquery.flot.resize.js"></script>
